    ...
    return (
        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
            ...
            <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center" data-aos="fade-up"data-aos-duration='1000'>
                <div>
                <div className='mb-5 md:w-auto w-52 space-y-1 box  border border-slate-500  p-2 rounded-xl' >
                ...
                <p className='font-semibold'><span className='font-bold'>Email</span>: {email}</p>
                    ...
                    <p className="mt-3 md:w-auto text-lg w-72 dark:text-gray-600">{description}</p>
                    <div className="mt-12 space-y-12">
                        <div className="flex">
                            <div className="flex-shrink-0">
                                <div className=" hidden md:flex items-center justify-center w-12 h-12 rounded-md dark:bg-violet-600 dark:text-gray-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-7 h-7">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                </div>
                            </div>
                            <div className="md:ml-4 w-72">
                        ...
                        <div className="md:flex items-center">
                            <div className="flex-shrink-0">
                                <div className="md:flex hidden items-center justify-center w-12 h-12 rounded-md dark:bg-violet-600 dark:text-gray-50">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-7 h-7">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                </div>
                        ...
                        <div className="md:flex ">
                            ...
                            <div className="md:ml-4">
                                <h4 className="text-lg font-medium leading-6 bg-slate-400 p-2 rounded-xl text-gray-200">{stock}</h4>
                                <p className="mt-2 dark:text-gray-600">Processing Time: {processing}</p>
                            </div>
                            <button type="button" className=" text-yellow-400 text-sm flex items-center md:ml-64 p-1 space-x-1.5">
			<FaStar></FaStar>
				<span>{rating}</span>
			</button>
                        </div>
