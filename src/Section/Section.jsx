...
const Section = () => {
    ...
    const {image,item_name,subcategory_name,description,price,rating,processing_time} = section
                    ...
                    <div className="mt-12 space-y-12">
                        ...
                        <div className="md:flex ">
                            ...
                            <div className="md:ml-4">
                                ...
                                <p className="mt-2 dark:text-gray-600">Processing Time: {processing_time}</p>
                            </div>
                            <button type="button" className=" text-yellow-400 text-sm flex items-center md:ml-64 md:p-1 md:space-x-1.5">
			<FaStar></FaStar>
				<span>{rating}</span>
			</button>
                        </div>
